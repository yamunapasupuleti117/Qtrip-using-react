...
//     let[api,setApi]=useState({"goa":[]})
//       useEffect(()=>{
//         let url=fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures?city=goa")
...
//                 <Link to={"/"+x.name} >
//                 <div>
//                 <img src={x.image} alt="" style={{height:"300px",width:"300px"}} />
//                 <p>{x.category}</p>
//                 <h5>{x.name}</h5>
//                 <p>duration</p>
//                 <p>{x.duration}</p>
...
// import { Link } from "react-router-dom";
// export default function Bengaluru(){
//     let[api,setApi]=useState({"sin":[]})
//       useEffect(()=>{
//         let url=fetch("https://content-qtripdynamic-qa-backend.azurewebsites.net//api/v1/adventures?city=bangkok")
//         url.then(x=>x.json()).then(x=>{
//             setApi({"sin":x})
//         })
//       },[])
